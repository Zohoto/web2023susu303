...
function App() {
    ...
    async function sendAndReceiveMovie(movie) {
        ...
        await fetch("https://my-json-server.typicode.com/Zohoto/web2023susu303/movies", {
            method: 'POST',
    ...
    return (
        <div>
            ...
            <div className="header">
                <b>Библиотека фильмов</b>
                <div className="authorBlock"><b>Андроник Андрей, КЭ-303</b></div>
            </div>
